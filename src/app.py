...
# Serve static files (HTML, future CSS/JS/images)
...
def load_models():
    ...
    try:
        ...
        scaler_path = os.path.join(MODELS_DIR, "scaler_merged.pkl")
        le_path = os.path.join(MODELS_DIR, "label_encoder_merged.pkl")
